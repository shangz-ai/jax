...
def if_building_jaxlib(
        if_building,
        if_not_building = [
            "//jaxlib/tools:jaxlib_wheel_library",
            "//jaxlib/tools:jax_cuda_plugin_wheel_library",
            "//jaxlib/tools:jax_cuda_pjrt_wheel_library",
        ],
        if_not_building_for_cpu = ["//jaxlib/tools:jaxlib_wheel_library"]):
